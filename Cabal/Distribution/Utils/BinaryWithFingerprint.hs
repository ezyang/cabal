...
-- changes.)
--
encodeWithFingerprint :: forall a. (Binary a, Generic a, Typeable (Rep a)) => a -> ByteString
...
--
decodeWithFingerprint :: forall a. (Binary a, Generic a, Typeable (Rep a)) => ByteString -> a
...
-- and report them.
--
decodeWithFingerprintOrFailIO :: (Binary a, Generic a, Typeable (Rep a)) => ByteString -> IO (Either String a)
