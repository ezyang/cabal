...
# Run tests
(CABAL_PACKAGETESTS_DB_STACK="clear:global:${CABAL_INPLACE_PKGDB}:${CABAL_STORE_PKGDB}"; cd Cabal && timed ${CABAL_BDIR}/build/package-tests/package-tests $TEST_OPTIONS) || exit $?
